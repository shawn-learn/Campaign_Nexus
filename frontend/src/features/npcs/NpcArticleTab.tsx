...
import { RelationsEditor } from '../wiki/RelationsEditor'
import { LinkPanel } from '../wiki/EntityDetailPage'

interface NpcArticleTabProps {
  campaignId: string
  entityId: string
  entity: EntityDetail
}

export function NpcArticleTab({ campaignId, entityId, entity }: NpcArticleTabProps) {
